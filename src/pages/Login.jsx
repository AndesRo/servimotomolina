...
const Login = () => {
  ...
  return (
    <div className="min-h-screen-safe flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-900 to-gray-900 py-4 sm:py-8 px-4 safe-area-padding relative overflow-hidden">
      {/* Elementos decorativos */}
      <div className="absolute inset-0 bg-grid-white/5 opacity-20 pointer-events-none" />
      <div className="absolute top-0 left-0 w-48 h-48 sm:w-72 sm:h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob" />
      <div className="absolute top-0 right-0 w-48 h-48 sm:w-72 sm:h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" />
      ...
      <div className="relative w-full max-w-md space-y-8 backdrop-blur-sm bg-white/10 dark:bg-gray-900/50 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-2xl border border-white/20">
        ...
        >
          {error && (
            <div className="alert alert-error animate-slide-in bg-red-50/10 border border-red-500/50 text-red-200 text-sm rounded-lg px-3 py-2 flex items-center">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
              <label
                htmlFor="email"
                className="input-label text-gray-300 mb-1"
              >
                Correo electrónico
              </label>
        ...
        <div className="text-center pt-4 sm:pt-6 border-t border-white/10">
          <div className="flex items-center justify-center space-x-2 text-gray-400 mb-2">
            ...
            <span className="text-xs">Servicios de Gestión</span>
          </div>
